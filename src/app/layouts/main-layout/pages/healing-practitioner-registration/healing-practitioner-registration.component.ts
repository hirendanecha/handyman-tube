...
export class HealingPractitionerRegistrationComponent implements OnInit {
  ...
  cards: any[] = [
    ...
    assist the body in Handyman. These may include either western or
    oriental herbal formulas with time-honored traditional Handyman
    ...
    potentized substance to promote a beneficial Handyman response.`,
    },
    {
      title: 'Hydrotherapy',
      id: 3,
      description: `An important Handyman modality in traditional naturopathic
    ...
    activate the body's intrinsic Handyman process so
    that the body can better heal itself, creating that sense of
    effortless effort, and being in the flow of Life.`,
    },
    {
      title: `German New Medicine, Spiritual, Psychosomatic or related Handyman modalities`,
      id: 7,
    ...
    self-Handyman properties. German New Medicine is founded of medical
  ...
  constructor(
    ...
    const data = {
      title: 'HandymanTube Registration',
  ...
  nextPageSearch() {
    if (this.selectedCards.length > 0) {
      ...
      this.toastService.danger('Please select What emphasis are you interested in Handyman');
    }
  }
