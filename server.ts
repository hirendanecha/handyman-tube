...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/handyman-tube/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/handyman-tube/browser'), 'index.html')
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          image:
            'https://www.handyman.tube/assets/images/Ht-Profile-pic-default.png',
          site: 'https://www.handyman.tube/',
          url: 'https://www.handyman.tube' + params,
          keywords: 'HandymanTube',
        };
        if (
          ...
          const talent = {
            ...
            image: post?.thumbfilename || post?.metaimage || post?.imageUrl || 'https://www.handyman.tube/assets/images/Ht-Profile-pic-default.png',
          };
          seo.title = talent.name;
          seo.description = strip_html_tags(talent.description);
          seo.image = talent.image;
          ...
          const talent = {
            name: `HandymanTube Research ${group?.PageTitle}`,
